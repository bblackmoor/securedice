...
?>
	...
	<form method="post" action="index.php" onsubmit="return validateRecaptcha();">
...
?>
		...
		<tr>
			...
			<td valign="top">
				<div class="g-recaptcha" data-sitekey="6LfHLYMeAAAAAPDDknaa-QqULFsYdMpSyV26kdKZ"></div>
				<input type="hidden" name="op" value="roll" />
				<input type="submit" name="submit" id="submit" value="Roll The Dice" />
				<input type="button" name="restart" value="Start Over" onclick="location.href='https://www.rpglibrary.org/software/securedice/';" />
			</td>
		</tr>
		</table>
	...
	<table border="0">
		...
		<tr>
			<th>dd= 
			<td>dice deviation: lowest, none, highest, <a href="http://en.wikipedia.org/wiki/D6_System#The_Wild_Die">wild</a>, <!-- <a href="https://ogc.rpglibrary.org/index.php?title=Bulletproof_Blues_3e_EN:Actions#Rolling_Dice">expertise</a>, --><a href="https://www.blackgate.net/blog/fantasy-age-the-stunt-die/">stunt</a>
		</tr>
		<tr>
			<th>mdq= 
...
function formatEmailMessage($email_message = '')
{
	...
	$formatted_message = "RPG Library Secure Dice generated the following rolls";
	...
	$formatted_message .= "\n\n-- \n";
	$formatted_message .= "Dice rolls generated by RPG Library Secure Dice\n";
	$formatted_message .= "https://www.rpglibrary.org/software/securedice/";
...
function generateDiceResults($data)
{
	...
	{
		$data["message"] .= "Each set of dice rolls issorted from high to low.\n";
	}
...
function mailDiceResults($data)
{
	...
	if (isSubjectValid($data["dice_subject"]))
	{
...
if ($data["op"] == 'roll')
{
	...
	$data['page_url']  = "https://www.rpglibrary.org/software/securedice/?op=";
